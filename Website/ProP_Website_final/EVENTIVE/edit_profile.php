...
<section id="main_cont" class="main_cont">
    ...
    <form action="" method="post">
        <div class="form-horizontal">
            ...
            <input type="text" class="form-control-static" style="background-color: lightgreen" name="edit_username" disabled id="UsernameField" placeholder="Username"
            value="<?php if (isset($username)) echo $username;?>">
        </div>
        <div class="form-horizontal">
            <label for="emailField">Email</label><br>
            <input type="text" class="form-control-static" style="background-color: lightgreen" name="edit_email" disabled id="emailField" placeholder="email"
